...
describe('PreviewImageList', () => {
    it('renders a list of images', () => {
        const images = [
            { id: 'img-1', url: 'https://example.com/image1.jpg', altText: 'Test Image 1' },
            { id: 'img-2', url: 'https://example.com/image2.jpg', altText: 'Test Image 2' },
            { id: 'img-3', url: 'https://example.com/image3.jpg', altText: 'Test Image 3' },
        ]
